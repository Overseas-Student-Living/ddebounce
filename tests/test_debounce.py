...
class TestDebounce:
    ...
    def test_debounce(self, debounced, debounce_applied, redis_, release, tracker):
        def coroutine():
    ...
    def test_debounce_failing_on_execution(self, debounced, redis_, release, tracker):
...
class TestDebounceWithCallback:
    ...
    def test_debounce(self, callback_tracker, debounced, redis_, release, tracker):
        def coroutine():
            return debounced("egg", spam="ham")
