...
from debounce_lock import Lock, debounce, debouncemethod
...
class TestLock:
    ...
    def test_debounce_with_callback(self, redis_):
    ...
    def test_debounce_failing_on_execution(self, redis_):
    ...
    def test_debounce_failing_on_repeat_execution(self, redis_):
...
class TestHelpers:
    ...
    def test_debouncemethod(self, redis_):
